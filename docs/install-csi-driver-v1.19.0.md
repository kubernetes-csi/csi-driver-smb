## Install SMB CSI driver v1.19.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.19.0/deploy/install-driver.sh | bash -s v1.19.0 --
```
