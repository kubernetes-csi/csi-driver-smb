## Install SMB CSI driver v1.20.1 version on a Kubernetes cluster
...
./deploy/install-driver.sh v1.20.1 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.20.1/deploy/uninstall-driver.sh | bash -s --
```
