## Install SMB CSI driver v1.19.1 version on a Kubernetes cluster
...
./deploy/install-driver.sh v1.19.1 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.19.1/deploy/uninstall-driver.sh | bash -s --
```
