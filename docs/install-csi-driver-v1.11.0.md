## Install SMB CSI driver v1.11.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.11.0/deploy/uninstall-driver.sh | bash -s --
```
...
cd csi-driver-smb
git checkout v1.11.0
./deploy/uninstall-driver.sh v1.11.0 local
```
