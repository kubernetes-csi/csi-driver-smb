## Install SMB CSI driver v1.8.0 version on a Kubernetes cluster
...
cd csi-driver-smb
git checkout v1.8.0
./deploy/install-driver.sh v1.8.0 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.8.0/deploy/uninstall-driver.sh | bash -s --
```
...
cd csi-driver-smb
git checkout v1.8.0
./deploy/uninstall-driver.sh v1.8.0 local
```
