## Install SMB CSI driver v1.3.0 version on a Kubernetes cluster

### Install by kubectl
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.3.0/deploy/install-driver.sh | bash -s v1.3.0 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.3.0/deploy/uninstall-driver.sh | bash -s --
```
