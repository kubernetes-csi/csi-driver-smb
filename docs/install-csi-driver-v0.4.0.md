## Install SMB CSI driver v0.4.0 version on a Kubernetes cluster

### Install by kubectl
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v0.4.0/deploy/install-driver.sh | bash -s v0.4.0 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v0.4.0/deploy/uninstall-driver.sh | bash -s --
```
