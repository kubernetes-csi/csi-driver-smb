## Install SMB CSI driver v1.20.3 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.20.3/deploy/install-driver.sh | bash -s v1.20.3 --
```
...
./deploy/install-driver.sh v1.20.3 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.20.3/deploy/uninstall-driver.sh | bash -s --
```
