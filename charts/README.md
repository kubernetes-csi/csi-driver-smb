...
| `image.krb5AutoConfig.repository`                       | image used by the optional krb5 auto-config initContainer (see `linux.krb5AutoConfig`)                     | `mcr.microsoft.com/cbl-mariner/busybox`                 |
| `image.krb5AutoConfig.tag`                              | krb5 auto-config image tag                                                                                 | `2.0`                                                   |
| `image.krb5AutoConfig.pullPolicy`                       | krb5 auto-config image pull policy                                                                         | `IfNotPresent`                                          |
