...
if [[ "$cloud" == 'AzurePublicCloud' ]] && [[ -n "$tenantId" ]] && [[ -n "$subscriptionId" ]] && [[ -n "$aadClientId" ]] && [[ -n "$aadClientSecret" ]] && [[ -n "$resourceGroup" ]] && [[ -n "$location" ]]; then
...
elif [[ "$cloud" == 'AzureChinaCloud' ]] && [[ -n "$tenantId" ]] && [[ -n "$subscriptionId" ]] && [[ -n "$aadClientId" ]] && [[ -n "$aadClientSecret" ]] && [[ -n "$resourceGroup" ]] && [[ -n "$location" ]]; then
